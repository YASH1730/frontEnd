...
export default function Orders() {
  ...
  return (
    ...
    ,gap : '15px'}}>  
               ...
               <Grid xs  = {12} md = {2.8} >
                    <TextField  fullWidth autoComplete = {false}  id="demo-helper-text-aligned-no-helper" label="Search by phone number" type = 'text'  />
                </Grid>
               ...
               <Grid xs  = {12} md = {2.8} >
                    <Box sx={{ minWidth: 120 }}>
                        <FormControl fullWidth>
                            <InputLabel id="demo-simple-select-label">Order Limits</InputLabel>
                            <Select
                            labelId="demo-simple-select-label"
                            id="demo-simple-select"
                            value={order}
                ...
                <Grid xs  = {12} md = {2.8} >
                   <Button  sx = {{width : '100%'}} color = 'primary'  startIcon={<GetAppIcon />} variant = 'contained' >Download Orders</Button>
                </Grid>
         </Grid>
