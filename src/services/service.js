...
export const getLinkedProduct = async(data) => {
    return await axios.get(`${API}/getLinkedProduct?ACIN=${data}`, {
        headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    });
...
export const linkToVariations = async(data) => {
    return await axios.post(`${API}/linkToVariations`, data, {
        headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    });
};
export const unlinkFromVariations = async(data) => {
    return await axios.post(`${API}/unlinkFromVariations`, data, {
        headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    });
